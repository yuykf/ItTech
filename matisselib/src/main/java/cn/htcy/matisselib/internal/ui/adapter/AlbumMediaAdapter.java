 ...
 */
package cn.htcy.matisselib.internal.ui.adapter;
...
import cn.htcy.matisselib.internal.entity.IncapableCause;
...
public  class AlbumMediaAdapter extends
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            ...
            // 内容
            Log.e("from: ", (parent.getContext() == null) + "");
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.gride_l, parent, false);
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            Log.e("Adapter: ", (null == item) + "item == null ");
...
//            return;
//        }
//        Cursor curonAlbumLoadsor = getCursor();
