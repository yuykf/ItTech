...
import cn.htcy.matisselib.internal.ui.AlbumPreviewActivity;
...
import cn.htcy.matisselib.internal.utils.PathUtils;
import cn.htcy.matisselib.internal.utils.PhotoMetadataUtils;
import cn.htcy.matisselib.internal.utils.SingleMediaScanner;
...
public class MatisseActivity extends AppCompatActivity implements
    ...
    private final String TAG = "MatesseActivity";
    ...
    public void onAlbumLoad(final Cursor cursor) {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("Adapter: ", "onAlbumLoad size" + album.getCount());
    ...
    private void onAlbumSelected(Album album) {
        long s = album.getCount();
        Log.e("Adapter: ", album.isAll() + "  " + album.isEmpty());
...
//        startActivityForResult(intent, REQUEST_CODE_PREVIEW);
    ...
    public SelectedItemCollection provideSelectedItemCollection() {
        Log.e("Adapter: ", "mSelectedCollection == null" + (mSelectedCollection == null));
