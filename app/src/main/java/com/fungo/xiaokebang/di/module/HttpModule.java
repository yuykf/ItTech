...
import com.fungo.xiaokebang.di.qualifier.MvpWanAndroidUrl;
...
public class HttpModule {
    ...
    @Singleton
    @Provides
    XiaoKeBangApis provideGeeksApi(@MvpWanAndroidUrl Retrofit retrofit) {
        return retrofit.create(XiaoKeBangApis.class);
    }
    ...
    Retrofit provideGeeksRetrofit(Retrofit.Builder builder, OkHttpClient client) {
        return createRetrofit(builder, client, XiaoKeBangApis.HOST);
    }
    ...
    OkHttpClient provideClient(OkHttpClient.Builder builder) {
        ...
        builder.cookieJar(new PersistentCookieJar(new SetCookieCache(),
                new SharedPrefsCookiePersistor(ItTechApplication.getInstance())));
